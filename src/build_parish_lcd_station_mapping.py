...
STATIONS_FILE = DATA_RAW / "louisiana_lcd_candidate_stations.csv"
OUTPUT_FILE = DATA_RAW / "parish_lcd_station_mapping.csv"
...
def main():
    ...
    # Use representative points for parishes
    ...
    parish_station_mapping = parish_station_mapping.rename(columns={
        "NAME": "parish",
    ...
    print(f"Saved parish LCD mapping to:\n{OUTPUT_FILE}")
    print("\nPreview:")
    ...
    print(
        f"Unique LCD stations used: {parish_station_mapping['lcd_station_id'].nunique()}"
    )
